...
export default function TeamStatsModal({ activeTeamStats, onClose }: TeamStatsModalProps) {
  ...
  return createPortal(
    ...
    >
      <div 
        className="w-full max-w-sm rounded-2xl liquid-glass p-6 shadow-2xl relative text-left overflow-hidden !bg-[rgba(255,255,255,0.95)] dark:!bg-[rgba(15,15,22,0.95)] border border-card-border"
